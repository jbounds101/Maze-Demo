Public Class Form2
    ...
    End Sub
    'Sets all walls to be a random color
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ElseIf N = 4 Then
            ...
            Color.Text = "Orange"
        End If
        TotalTime.Text = Form1.TotalTime.Text
    End Sub
    'Starts timer when WASD is pressed
    Private Sub Form1_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        If lblMove.Bounds.IntersectsWith(c1.Bounds) Or
            ...
            'Resets the "player" to the box when colliding with walls
            lblMove.Left = 72
            lblMove.Top = 159
